...
const adminItems = [
  ...
  { label: "Expiring (20d)", href: "/dashboard/admin/expiring", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  ...
  { label: "Search", href: "/dashboard/admin/search", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
];
